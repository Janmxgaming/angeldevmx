...
export default function HomePage({ setCurrentPage }) {
  ...
  const gradientFrom = isNeon ? '#00ff41' : '#0EA5E9';
  const gradientVia = isNeon ? '#4dff88' : '#38BDF8';
  const gradientTo = isNeon ? '#00ff41' : '#0EA5E9';
      ...
      <div className="text-center space-y-8 max-w-4xl">
        ...
        <div className="flex justify-center mb-8" key={`logo-${theme}`}>
          <div 
            ...
            style={{
              ...
              boxShadow: `0 0 60px ${primaryColorRgba}, 0.6), 0 0 100px ${primaryColorRgba}, 0.3)`
            }}
          >
        ...
        <div className="space-y-4" key={theme}>
          <p 
            ...
            style={{
              color: primaryColor,
              textShadow: `0 0 20px ${primaryColorRgba}, 0.8), 0 0 40px ${primaryColorRgba}, 0.5)`,
              letterSpacing: '0.2em'
            }}
          >
            {t.home.welcome}
        ...
        <div className="flex justify-center pt-8">
          <button
            ...
            style={{
              background: `linear-gradient(135deg, ${gradientFrom} 0%, ${gradientVia} 100%)`,
              boxShadow: `0 0 30px ${primaryColorRgba}, 0.6), 0 10px 40px rgba(0, 0, 0, 0.5)`,
        ...
        <div className="pt-12 flex justify-center">
          <div 
            ...
            style={{
              ...
              boxShadow: `0 0 20px ${primaryColorRgba}, 0.6)`
            }}
          />
        </div>
      </div>
